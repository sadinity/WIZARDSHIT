...
public class FlutterAnimations {
                ...
                public static final Animation FLUTTER_WALK = Animation.Builder.create(1.75F).looping()
                        .addBoneAnimation("wingR", new Transformation(Transformation.Targets.ROTATE,
                                new Keyframe(0.0F, AnimationHelper.createRotationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.CUBIC),
                                new Keyframe(0.2083F, AnimationHelper.createRotationalVector(0.0F, -60.0F, 0.0F), Transformation.Interpolations.CUBIC),
                                ...
                                new Keyframe(1.0417F, AnimationHelper.createRotationalVector(0.0F, -60.0F, 0.0F), Transformation.Interpolations.CUBIC),
                                new Keyframe(1.2917F, AnimationHelper.createRotationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.CUBIC),
                                new Keyframe(1.5417F, AnimationHelper.createRotationalVector(0.0F, -60.0F, 0.0F), Transformation.Interpolations.CUBIC),
                        ...
                        .addBoneAnimation("wingR", new Transformation(Transformation.Targets.SCALE,
                                ...
                                new Keyframe(0.2083F, AnimationHelper.createScalingVector(1.0F, 1.0F, 1.0F), Transformation.Interpolations.CUBIC),
                ...
                public static final Animation FLUTTER_IDLE = Animation.Builder.create(1.3333F).looping()
                        .addBoneAnimation("wingR", new Transformation(Transformation.Targets.ROTATE,
                                new Keyframe(0.0F, AnimationHelper.createRotationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.CUBIC),
        ...
        public static final Animation FLUTTER_SIT = Animation.Builder.create(2.5F)
                .addBoneAnimation("wingR", new Transformation(Transformation.Targets.ROTATE,
